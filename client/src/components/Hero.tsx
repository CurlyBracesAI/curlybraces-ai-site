        ...
        <div className="lg:w-1/2 lg:pr-12 relative">
          <div className="relative">
            ...
            <p className="text-base md:text-lg text-muted-foreground mb-8 leading-relaxed text-left" data-testid="text-hero-subtitle">
              In nature, adaptation defines survival. Powered by <strong className="text-foreground">Rosie</strong>, our intelligent Agentic AI workflow assistant is built for real-world performance.
              <br />
