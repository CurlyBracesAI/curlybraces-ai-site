export default function SupportedPlatforms() {
  ...
  return (
    <section id="integrations" className="py-12 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-snug" data-testid="text-platforms-subtitle">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* EHRs */}
          <div className="bg-card/30 p-6 rounded-2xl border border-card/50">
          ...
          <div className="bg-card/30 p-6 rounded-2xl border border-card/50 flex flex-col">
            <h3 className="text-sm font-semibold text-cyan-400 uppercase tracking-wider mb-6 text-center">
              Lightweight Workflows
            </h3>
            <div className="flex flex-wrap gap-x-10 gap-y-6 justify-center items-center flex-1">
