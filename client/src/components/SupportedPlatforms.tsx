      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          ...
          <div className="bg-card/30 p-3 rounded-lg border border-card/50">
            <h3 className="text-[10px] font-semibold text-cyan-400 uppercase tracking-wider mb-2 text-center">
              EHR Platforms
            </h3>
            <div className="flex flex-wrap gap-x-6 gap-y-1 justify-center items-center">
              ...
              <span className="text-muted-foreground text-[10px] font-medium">and similar platforms</span>
            </div>
          </div>
          ...
          <div className="bg-card/30 p-3 rounded-lg border border-card/50 flex flex-col">
            ...
            <p className="text-[9px] text-muted-foreground text-center mt-1 italic opacity-70">
